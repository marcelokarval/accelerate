...
| `Browser-Proof Auditor` | runtime/product review skill + active stack skills as needed | browser truth |
| `Runtime/Product Reviewer` | runtime/product review skill | runtime-sensitive user surface |
