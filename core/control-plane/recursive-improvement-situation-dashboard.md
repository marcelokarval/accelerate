...
- Linear MCP writes remain `planned` for repo-local read/create/artifact-comment/closure-comment/status-transition helper shape until live non-sensitive fixture proof exists; RC18 preflight evidence is readiness/blocker evidence, not provider availability proof.
