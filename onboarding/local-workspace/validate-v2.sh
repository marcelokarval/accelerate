...
required_files=(
  ...
  "${WORKSPACE}/review/ship-readiness.json"
  "${WORKSPACE}/review/deploy-verification-packet.md"
  "${WORKSPACE}/review/production-risk-approval.md"
...
require_enum "${WORKSPACE}/state.yaml" "active_profile" "unknown" "django-inertia-react" "nextjs-tailwind" "nextjs-prisma" "nextjs-drizzle" "nextjs-adonis-adminjs"
