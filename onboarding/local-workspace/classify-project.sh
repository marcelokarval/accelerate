...
provider_signals="$(yaml_value "${DISCOVERY_FILE}" "provider_signals")"
runtime_overlay_signals="$(yaml_value "${DISCOVERY_FILE}" "runtime_overlay_signals")"
...
selected_provider_overlays="${provider_signals:-[]}"
selected_runtime_overlays="${runtime_overlay_signals:-[]}"
...
set_scalar "${DECISIONS_FILE}" "selected_provider_overlays" "${selected_provider_overlays}"
set_scalar "${DECISIONS_FILE}" "selected_runtime_overlays" "${selected_runtime_overlays}"
