...
require_match 'structured_write: yes' "$REMOTE_REGISTRY"
require_match 'linear-mcp-closure-comment' "$REMOTE_REGISTRY"
require_match 'linear-mcp-status-transition' "$REMOTE_REGISTRY"
