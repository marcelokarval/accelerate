...
`autoresearch` is forensic self-improvement based on delivery evidence.
...
Do not treat issue creation or issue-detail writing by the agent as equivalent
to that approval.
