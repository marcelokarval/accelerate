# TASK-V08-R: Factual V3 Contract Extraction (Read-Only)

**Timestamp:** 2026-09-04T14:26:00-04:00
...
- **REVIEW requires prior START:** `if phase in V3_ANNOTATION_PHASES: if not seen.get("START"): errors.append("v3 PROGRESS and BLOCKED require a prior START event")` (Lines 259-261)
...
CANDIDATE_DIR="/home/marcelo-karval/.local/share/plane-mcp-karval/releases/26488c53ec9852ae8d02adfecaf86694f50e3c8c/apps/mcp-servers/plane-mcp-karval"
...
uv run pytest tests/test_plane_lifecycle_contract_v3.py tests/test_plane_operator_v3.py tests/test_plane_lifecycle_contract_v2.py \
    > planning/evidence/dated-proof-appendix/hermes-238/pytest-stdout.log \
    2> planning/evidence/dated-proof-appendix/hermes-238/pytest-stderr.log
EXIT_CODE=$?
echo $EXIT_CODE > planning/evidence/dated-proof-appendix/hermes-238/pytest-exit.receipt
...
sha256sum docs/HERMES-236-v3-test-matrix.md
sha256sum src/plane_mcp_karval/assets/plane-state-role-registry.v3.json
sha256sum tests/test_plane_lifecycle_contract_v3.py
sha256sum tests/test_plane_operator_v3.py
sha256sum src/plane_mcp_karval/lifecycle_transition_contract.py
sha256sum src/plane_mcp_karval/server.py
```
