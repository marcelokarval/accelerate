...
| workflow catalog | strong | native | near parity | focused retest exposed and corrected a real under-call around benchmark result registration; post-correction explicit/light reruns and one full independent local-vs-legacy rerun now select the right lane family and no-promotion blocker, but promotion still needs one more promotion-targeted proof cycle or live non-synthetic use |
